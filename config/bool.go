...
// AsBoolT returns the boolean representation of the value associated with k,
...
// AsBoolF returns the boolean representation of the value associated with k,
// or true if k is undefined.
//
// It returns true if the value "true", "yes" or "on", or false if the value is
// "false", "no" or "off".
...
// AsBoolDefault returns the boolean representation of the value associated
